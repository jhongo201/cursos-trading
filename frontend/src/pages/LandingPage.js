...
export const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A]">
      <nav className="glass border-b border-zinc-800 sticky top-0 z-50">
      ...
      <section className="max-w-7xl mx-auto px-6 py-20 md:py-32" data-testid="hero-section">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-heading font-bold tracking-tighter leading-none text-zinc-50 mb-6">
      ...
      <section className="max-w-7xl mx-auto px-6 py-20" data-testid="features-section">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-8 hover:-translate-y-1 hover:shadow-md hover:border-zinc-700 transition-all duration-200">
            <div className="bg-zinc-900 rounded-lg w-12 h-12 flex items-center justify-center mb-4">
              <BookOpen className="h-6 w-6 text-zinc-50" strokeWidth={1.5} />
            </div>
            <h3 className="text-xl font-heading font-semibold text-zinc-50 mb-2">Cursos Variados</h3>
            <p className="text-zinc-600">Accede a una amplia biblioteca de cursos en diferentes áreas de conocimiento.</p>
          </div>

          <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-8 hover:-translate-y-1 hover:shadow-md hover:border-zinc-700 transition-all duration-200">
            <div className="bg-zinc-900 rounded-lg w-12 h-12 flex items-center justify-center mb-4">
              <Video className="h-6 w-6 text-zinc-50" strokeWidth={1.5} />
            </div>
            <h3 className="text-xl font-heading font-semibold text-zinc-50 mb-2">Video Lecciones</h3>
            <p className="text-zinc-600">Aprende con contenido en video de alta calidad y bien estructurado.</p>
          </div>

          <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-8 hover:-translate-y-1 hover:shadow-md hover:border-zinc-700 transition-all duration-200">
            <div className="bg-zinc-900 rounded-lg w-12 h-12 flex items-center justify-center mb-4">
              <TrendingUp className="h-6 w-6 text-zinc-50" strokeWidth={1.5} />
            </div>
            <h3 className="text-xl font-heading font-semibold text-zinc-50 mb-2">Seguimiento</h3>
            <p className="text-zinc-600">Rastrea tu progreso y completa los cursos a tu propio ritmo.</p>
          </div>

          <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-8 hover:-translate-y-1 hover:shadow-md hover:border-zinc-700 transition-all duration-200">
            <div className="bg-zinc-900 rounded-lg w-12 h-12 flex items-center justify-center mb-4">
              <Award className="h-6 w-6 text-zinc-50" strokeWidth={1.5} />
            </div>
            <h3 className="text-xl font-heading font-semibold text-zinc-50 mb-2">Certificados</h3>
      ...
      <section className="max-w-7xl mx-auto px-6 py-20" data-testid="cta-section">
        <div className="bg-zinc-950 rounded-lg p-12 md:p-16 text-center">
          ...
          <Link to="/pricing">
            <Button size="lg" className="bg-white text-zinc-50 hover:bg-zinc-100" data-testid="cta-pricing-btn">
              Ver Planes
            </Button>
          </Link>
        </div>
